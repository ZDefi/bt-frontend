...
import iloMasterChef from 'config/abi/iloMasterchef.json'
...
import nftFarmAbi from 'config/abi/nftFarm.json'
import nftTokenAbi from 'config/abi/nftToken.json'
import poolFarmMasterChefAbi from 'config/abi/poolFarmMasterChef.json'
import flyNodeAbi from 'config/abi/flyNode.json'
...
export const getBabyContract = (web3?: Web3) => {
  return getContract(babyAbi, getBabyAddress(), web3)
}
export const getCakeContract = (web3?: Web3) => {
  return getContract(cakeAbi, getCakeAddress(), web3)
}
export const getVdrContract = (web3?: Web3) => {
  return getContract(bep20Abi, getVdrAddress(), web3)
}
...
export const getIloMasterchefContract = (web3?: Web3) => {
  return getContract(iloMasterChef, getIloMasterChefAddress(), web3)
}
export const getSwapFacotoryContract = (web3?: Web3) => {
  return getContract(swapFactoryAbi, getSwapFactoryAddress(), web3)
}
export const getNftFarmContract = (web3?: Web3) => {
  return getContract(nftFarmAbi, getNftFarmAddress(), web3)
}
export const getNftTokenContract = (web3?: Web3) => {
  return getContract(nftTokenAbi, getNftTokenAddress(), web3)
}
export const getPoolFarmsContract = (web3?: Web3) => {
  return getContract(poolFarmMasterChefAbi, getPoolMasterChefAddress(), web3)
}
export const getFlyNodeContract = (web3?: Web3) => {
  return getContract(flyNodeAbi, getFlyNodeAddress(), web3)
}
