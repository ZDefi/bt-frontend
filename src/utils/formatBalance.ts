...
export const getBalanceNumbertoFixed = (balance: BigNumber, decimals = 18) => {
  return balance.lt(new BigNumber(`1e${decimals-2}`)) ?
    getBalanceAmount(balance, decimals).toNumber().toFixed(5)
    :
