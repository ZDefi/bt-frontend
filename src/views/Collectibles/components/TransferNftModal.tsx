...
const TransferNftModal: React.FC<TransferNftModalProps> = ({ nft, onSuccess, onDismiss }) => {
    ...
    try {
      ...
      if (!isValidAddress) {
        ...
        await contract.methods
          .transferFrom(account, value, nft.tokenId)
          .send({ from: account })
          .on('sending', () => {
            setIsLoading(true)
          })
  ...
  return (
    <Modal title={t('Input the Address')} onDismiss={onDismiss}>
      <ModalContent>
        {error && (
