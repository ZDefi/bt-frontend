...
// import { getBabyContract } 'utils/contractHelpers'
import { useBabyBalance } from 'hooks/useTokenBalance'
...
const ExpandedFooter: React.FC<ExpandedFooterProps> = ({ pool, account, isAutoVault = false }) => {
  ...
  const babyBalanceOfMasterchef = useBabyBalance(poolContractAddress)
  const totalStakedBaby = getBalanceNumber(babyBalanceOfMasterchef)
    ...
    <ExpandedWrapper flexDirection="column">
      <Flex mb="2px" justifyContent="space-between" alignItems="center">
        ...
        <Flex alignItems="flex-start">
          {totalStaked ? (
            <>
              <Balance fontSize="14px" value={totalStakedBaby} />
